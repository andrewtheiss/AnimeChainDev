...
import { DEV_FAUCET_ABI, NETWORKS, DEV_FAUCET_MESSAGES } from './contracts';
import './Faucet.css';
...
export default function Faucet({ contractAddress, network = 'animechain_testnet', onConnectionUpdate }) {
  ...
  const [chainImgSrc, setChainImgSrc] = useState('/assets/images/animechain.webp');
    ...
    <div className="faucet-container dark-theme">
      ...
      <div className="logo-container">
        <img
          ...
          onError={() => {
            // Fallback to .png if .webp is missing on this deployment.
            if (chainImgSrc === '/assets/images/animechain.webp') setChainImgSrc('/assets/images/animechain.png');
          }}
        />
        <img src="/assets/images/animecoin.webp" alt="Animecoin Logo" className="coin-logo" />
      </div>
      {isInitializing ? (
